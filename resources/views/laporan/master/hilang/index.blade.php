...
@section('active_page')
    <li>Laporan</li>
    <li class="active">Barang Hilang</li>
@endsection
        ...
        <div class="row">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Cetak Laporan Daftar Barang Hilang</h3>
                    </div>
                    ...
                    <div class="box-body pad table-responsive">
                        ...
                        <div class="row">
                            ...
                            @if(Auth::user()->can('cetak_laporan_hilang'))
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    {!! Form::open(['url' => '/laporan/hilang', 'method'=>'POST', 'id'=>'formcetak']) !!}
...
@section('custom_script_footer')
    <script src="/js/laporan/hilang.js"></script>
@endsection
