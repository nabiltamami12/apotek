        ...
        <div class="row">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Cetak Laporan Daftar Opname Barang</h3>
                    </div>
                    ...
                    <div class="box-body pad table-responsive">
                        ...
                        <div class="row">
                            ...
                            @if(Auth::user()->can('cetak_laporan_stokopname'))
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    {!! Form::open(['url' => '/laporan/opname', 'method'=>'POST', 'id'=>'formcetak']) !!}
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTableBuilder">
                            ...
                            <tr>
                                ...
                                <th class="col-md-3">Data Barang</th>
                                <th class="col-md-1">Stok</th>
                                <th class="col-md-1">Nyata</th>
...
@section('custom_script_footer')
    <script src="/js/laporan/opname.js"></script>
@endsection
