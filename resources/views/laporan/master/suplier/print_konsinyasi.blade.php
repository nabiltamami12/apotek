...
<table id="dataTableBuilder" class="table table-striped table-bordered table-hover display select tg"
    ...
    <tr>
        ...
        <th style="width: 10%;" class="tg-3wr7"><strong>Harga Jual</strong></th>
        <th style="width: 10%;" class="tg-3wr7"><strong>Omset</strong></th>
        <th style="width: 10%;" class="tg-3wr7"><strong>Laba Kotor</strong></th>
    </tr>
    </thead>
    <tbody>
	<?php 
    ...
    @foreach($konsinyasi as $i => $value)
        ...
        <tr>
           ...
           <!-- <td style="width:5%; text-align: center;" class="tg-rv4w">0</td>-->
            ...
            <td style="width:5%;">{{ number_format($value->hpp, 0, ',', '.') }}</td>
            <td style="width:5%;">{{ number_format($totalhpp, 0, ',', '.') }}</td>
            <td style="width:5%;">{{ number_format($value->harga_jual_1, 0, ',', '.') }}</td>
            <td style="width:5%;">{{ number_format($omset, 0, ',', '.') }}</td>
            <td style="width:5%;">{{ number_format($labakotor, 0, ',', '.') }}</td>
        </tr>
		<?php 
    ...
    @endforeach
		<tr>
            ...
            <td class="tg-rv4w"><strong class="tg-3wr7">-</strong></td>
            <td class="tg-rv4w"><strong class="tg-3wr7">{{ number_format($G_omset, 0, ',', '.') }}</strong></td>
            <td class="tg-rv4w"><strong class="tg-3wr7">{{ number_format($G_lk, 0, ',', '.') }}</strong></td>
        </tr>
