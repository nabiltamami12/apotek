...
<table id="dataTableBuilder" class="table table-striped table-bordered table-hover display select tg"
    ...
    @foreach($pembelian as $i => $value)
        <tr>
            ...
            <td style="width:15%; text-align: center;" class="tg-rv4w">{{ $value->tgl->format('d/m/Y') }}</td>
            <td style="text-align: center;" class="tg-rv4w">{{ $value->user->fullname }}</td>
            <td style="width: 25%; text-align: right;" class="tg-rv4w">{{ number_format($value->total(), 0, ',', '.') }}</td>
        ...
        @foreach($value->pembeliandetail as $detail)
            <tr>
                ...
                <td style="width: 5%; text-align: center;" class="tg-rv4w-detail">{{ $detail->jumlah }}</td>
                ...
                <td style="width:25%; text-align: right;" class="tg-rv4w-detail">{{ number_format($detail->harga * $detail->jumlah, 0, ',', '.') }}</td>
