<div class="row">
    ...
    <div class="col-sm-12 form-horizontal form-left">
        <div class="form-group">
            <label for="harga_jual" class="control-label col-sm-3">Harga</label>
            <div class="col-sm-9">
                <input type="text" name="harga_jual" value="" id="harga_jual" class="form-control inputanangka" required />
            </div>
        </div>
    </div>
