                      ...
                      <div class="col-sm-12 form-horizontal">
                            ...
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        {!! Form::text('harga_jual', null, ['id'=>'harga_jual', 'class' => 'form-control inputanangka', 'disabled', 'placeholder'=>'Harga Jual']) !!}
                                    </div>
                   ...
                   <table width="100%" class="table table-striped table-bordered table-hover" id="dataTableBuilder">
                          ...
                          <div class="row">
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <label for="tipe_bayar" class="control-label col-sm-3">Tipe Bayar: </label>
                                        <div class="col-sm-3">
											<input type="radio" name="tipe_bayar" id="tipe_bayar" value="1" checked> Tunai
                                        </div>
										<div class="col-sm-3">
											<input type="radio" name="tipe_bayar" id="tipe_bayar" value="2"> Debit
                                        </div>
										<div class="col-sm-3">
											<input type="radio" name="tipe_bayar" id="tipe_bayar" value="3"> Kredit
                                        </div>
                                    </div>
                                </div>
								<!--<div class="form-group">
                                    <div class="col-sm-12">
									<label for="who_shop" class="control-label col-sm-3">Pembeli: </label>
										<div class="col-sm-3">
											<input type="radio" name="who_shop" id="who_shop" value="1" checked> Personal
                                        </div>
										<div class="col-sm-5">
											<input type="radio" name="who_shop" id="who_shop" value="2"> Rombongan
                                        </div>
