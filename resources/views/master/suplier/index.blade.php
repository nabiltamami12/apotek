...
@section('content')
    <section class="content">
        <div class="row">
				@if(Auth::user()->can('tambah_suplier'))
                <div class="col-xs-3">
            ...
            @endif
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Daftar Suplier</h3>
                    </div>
					@include('master.suplier.modal')
                    <div class="box-body">
...
@section('custom_script_footer')
    <script src="/js/master/suplier.js"></script>
@endsection
